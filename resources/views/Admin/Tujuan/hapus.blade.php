    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-body text-center p-4 pb-5">
                ...
                <h3 class="mb-5">Yakin hapus <span id="vtujuan"></span> ?</h3>
                <input type="hidden" name="idtujuan" id="idtujuan">
...
<script>
    function submitFormH() {
        setLoadingH(true);
        const id = $("input[name='idtujuan']").val();
        $.ajax({
            type: 'POST',
            url: "{{url('admin/tujuan/proses_hapus')}}/" + id,
